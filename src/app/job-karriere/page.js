                ...
                <div className="flex flex-col md:flex-row pt-10 text-lg">
                    ...
                    <div className="flex-1 items-start justify-end hidden lg:flex">
                        <Image
                            ...
                            src="https://images.unsplash.com/photo-1681949101473-9aea8b928a55?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                            width={400}
                            height={800}
                            alt="test"
                        />
