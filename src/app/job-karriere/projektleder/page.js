...
export const metadata = {
    title: 'Job & Karriere - Projektleder',
};

export default function Projektleder() {
    return (
        <>
            <Hero backgroundImage="https://images.unsplash.com/photo-1423666639041-f56000c27a9a?q=80&w=2074&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" title="projektleder" />
